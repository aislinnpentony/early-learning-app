<template>
  <div id="app">
    <h1>Select one of the below subjects to access worksheets!!</h1>
...
export default {
  ...
  methods: {
     goToToMath() {
      this.$router.push('/user/P7/MathSheet6')
    },
    goToToEnglish() {
      this.$router.push('/user/P7/EnglishSheet6')
    },
    goToToScience() {
      this.$router.push('/user/P7/ScienceSheet6')
  }
}
}
</script>
